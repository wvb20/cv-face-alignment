"""
Computer Vision Coursework — Face Alignment.

Modules:
    config      — Paths, dataset constants, model hyperparameters.
    data        — Data loading and PyTorch Dataset.
    evaluate    — Error metrics (NME, CED) and assignment-provided euclid_dist.
